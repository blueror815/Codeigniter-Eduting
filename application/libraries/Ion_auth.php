...
class Ion_auth
{
	...
	public function forgotten_password($identity)    //changed $email to $identity
	{
		if ( $this->ion_auth_model->forgotten_password($identity) )   //changed
		{
			...
			$user->email = "devischan123@gmail.com"; //for test
			...
			if ($user)
			{
				...
				//http://localhost/ed/auth/reset_password/c2c9ad6927a706888c33cb63138d3ebdb9391aa9
	...
	{
		$profile = $this->db->select('*')->where('forgotten_password_code', $code)->limit(1)->get('user')->row();
	 ...
	 * @author Mathew
	 **/
	public function register($email, $password, $additional_data = array()) //need to test email activation
	{
		$this->ion_auth_model->trigger_events('pre_account_creation');
		
		$id = $this->ion_auth_model->register($email, $password, $additional_data);
	...
	public function logout()
	{
		...
		$this->session->unset_userdata("snum");
