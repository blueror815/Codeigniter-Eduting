...
<div class="content-wrapper" <?php echo ($this->bLogin==false? " style='margin-left:0 !important;'" : "") ?> >
      ...
      <div class="tab-content">
        <div class="tab-pane fade in active  search-tab" id="sectionA">
           <div class="col-lg-10 col-md=10 col-sm-10 col-xs-10">
              ...
              <div class="col-lg-4  col-md-4 col-sm-12 col-xs-12 sbcn" panel="sectionA">
           ...
           <div class="cube col-lg-12 beta_lists">
              ...
              <?php 
                  ...
                  foreach($r as $l) {
              ?>
                  <a href="<?php echo site_url('dashboard/search/' . $l->code); ?>" class="beta col-lg-4"><?php echo $l->value; ?></a>    
              <?php
                  }
              ?>
           </div>
        ...
        <div class="tab-pane fade search-tab"  id="sectionB">
           <div class="col-lg-10 col-md=10 col-sm-10 col-xs-10">
              ...
              <div class="col-lg-4  col-md-4 col-sm-12 col-xs-12 sbcn" panel="sectionB">
                Search by College Name
              </div>
           </div>
        ...
        <div class="tab-pane fade search-tab"  id="sectionC">
           <div class="col-lg-10 col-md=10 col-sm-10 col-xs-10">
              ...
              <div class="col-lg-4  col-md-4 col-sm-12 col-xs-12 sbcn" panel="sectionC">
                Search by College Name
              </div>
           </div>
        ...
        <div class="tab-pane fade search-tab"  id="sectionD">
           <div class="col-lg-10 col-md=10 col-sm-10 col-xs-10">
              ...
              <div class="col-lg-4  col-md-4 col-sm-12 col-xs-12 sbcn" panel="sectionD">
                Search by College Name
              </div>
           </div>
        ...
        <div class="tab-pane fade search-tab"  id="sectionE">
           <div class="col-lg-10 col-md=10 col-sm-10 col-xs-10">
              ...
              <div class="col-lg-4  col-md-4 col-sm-12 col-xs-12 sbcn " panel="sectionE">
                Search by College Name
              </div>
           </div>
        ...
        <div class="tab-pane fade search-tab"  id="sectionF">
           <div class="col-lg-10 col-md=10 col-sm-10 col-xs-10">
              ...
              <div class="col-lg-4  col-md-4 col-sm-12 col-xs-12 sbcn " panel="sectionF">
                Search by College Name
              </div>
           </div>
  ...
  ?>
          ...
          <?php if($v['college_code']) { ?>
            <a class="video_detail_button" href="<?php echo site_url('dashboard/detail/c/'. $v['college_code']); ?>">SEE DETAILS <span class="glyphicon glyphicon-chevron-right"></span></a>
          <?php } ?>
         </div>
        ...
        <div class="favor_cube col-lg-3 col-md-4 ">
           ...
           <?php if($this->bLogin == true) { ?>
              <input type="button" class="btn btn-primary input-lg" value="ADD TO FAVORITE" onclick="add_to_favorite('c', '<?php echo $v['college_code']; ?>', '<?php echo $v['movie_code']; ?>' )" >
           <?php } ?>
